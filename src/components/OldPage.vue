...
<template>
  <div id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="">
              <a class="page-scroll" href="#sqt">STQ</a>
            </li>
            <li class="">
    ...
    <section id="sqt">
      <div class="content-section section-sqt">
        <img
          src="/images/TPD_Snap_Text_Quote_Image.jpg"
          class="img-responsive my_mobile"
        />
        ...
        <div class="container">
          <div class="col-md-7 col-md-offset-5">
            <h1>
              ...
              ><span class="common-text-color">TEXT, </span
              ><span class="grey">QUOTE.</span>
            </h1>
            <p>
              We understand youʼre busy, and frankly, so are we. So weʼve devised a simple
              strategy to make life easier for both of us. Itʼs almost like rocket
              science, for <i>pre-schoolers.</i>
            </p>
            <p>
              Simply <b>SNAP</b> your job on your Smart Phone or Tablet, <b>TEXT</b> the
              photos through to our mobile number, and receive an estimated repair
              <b>QUOTE</b> within a couple of hours. Be also sure to include your name,
              suburb, and any special details or requests.
            </p>
    ...
    <section id="portfolio">
      <div class="content-section section-portfolio">
        <div class="container">
          <div class="text-center">
        ...
        <div class="container">
          <ul id="portfoliogrid" class="row portfolio desktop_text shuffle">
            <li
              class="col-lg-3 col-sm-6 col-xs-6 portfolio-item shuffle-item filtered"
              data-groups='["all", "basement", "kitchen", "paintaing"]'
            >
              <figure>
                <div>
                  <img src="/images/work/TPD_Gallery 3.jpg" alt="img06" loading="lazy" />
                </div>
                <figcaption>
                  <h4>Interior Repaint</h4>
                  <!--<span>Sub Title</span>-->
                  <p class="light_grey">Location: Thornbury</p>
                  <p>
                    Complete 2 room crack repair &amp; repaint of an Art Deco property in
                    Thornbury.
                  </p>
                  <a
                    href="/images/work/Gallery_Fyffe%20St_Before%20&amp;%20After.jpg"
                    data-rel="prettyPhoto[work_gallery]"
                    title="FULL REPAIR &amp; REPAINT. FYFFE ST, THORNBURY."
                    >Take a look</a
                  >
                </figcaption>
              </figure>
            ...
            <li
              class="col-lg-3 col-sm-6 col-xs-6 portfolio-item shuffle-item filtered"
              data-groups='["all", "sanitary", "kitchen", "electrical"]'
            >
              <figure>
                <div>
                  <img src="/images/work/TPD_Gallery 2.jpg" alt="img02" loading="lazy" />
                </div>
                <figcaption>
                  <h4>CAFE RENOVATION</h4>
                  <!--<span>Sub Title</span>-->
                  <p class="light_grey">Location: Richmond</p>
                  <p>
                    Complete plaster repair &amp; repaint of a new organic food cafe on
                    the outskirts of Richmond.
                  </p>
                  <a
                    href="/images/work/FOG%20Montage_Website.jpg"
                    data-rel="prettyPhoto[work_gallery]"
                    title="COMPLETE INTERIOR/EXTERIOR REPAINT. FRESH ORGANIC GOODS, RICHMOND"
                    >Take a look</a
                  >
                </figcaption>
              </figure>
            ...
            <li
              class="col-lg-3 col-sm-6 col-xs-6 portfolio-item shuffle-item filtered"
              data-groups='["all", "kitchen", "paintaing"]'
            >
              <figure>
                <div>
                  <img src="/images/work/TPD_Gallery 1.jpg" alt="img04" loading="lazy" />
                </div>
                <figcaption>
                  <h4>Extension Plastering</h4>
                  <!--<span>Sub Title</span>-->
                  <p class="light_grey">Location: Epping</p>
                  <p>Plastering of a brand new rumpus room extension in Epping.</p>
                  <a
                    href="/images/work/TPD_Gallery_Photo%203%20Collage.jpg"
                    data-rel="prettyPhoto[work_gallery]"
                    loading="lazy"
                    title="COMPLETE EXTENSION PLASTERING IN EPPING"
                    >Take a look</a
                  >
                </figcaption>
              </figure>
            ...
            <li
              class="col-lg-3 col-sm-6 col-xs-6 portfolio-item shuffle-item filtered"
              data-groups='["all", "electrical", "kitchen"]'
            >
              <figure>
                <div>
                  <img src="/images/work/TPD_Gallery 4.jpg" alt="img01" loading="lazy" />
                </div>
                <figcaption>
                  <h4>Plaster Repairs</h4>
                  <!--<span>Sub Title</span>-->
                  <p class="light_grey">Location: Melbourne CBD</p>
                  <p>
                    Numerous repairs &amp; painting preparation work for a modern office
                    building in St Kilda Rd, Melbourne.
                  </p>
                  <a
                    href="/images/work/Gallery_Photo%204%20Collage.jpg"
                    data-rel="prettyPhoto[work_gallery]"
                    title="PRE-PAINTING REPAIR WORK. ST KILDA RD, MELBOURNE"
                    >Take a look</a
                  >
                </figcaption>
              </figure>
            ...
            <li
              class="col-lg-3 col-sm-6 col-xs-6 portfolio-item shuffle-item filtered"
              data-groups='["all", "plumbing","kitchen"]'
            >
              <figure>
                <div>
                  <img src="/images/work/TPD_Gallery 5.jpg" alt="img03" loading="lazy" />
                </div>
                <figcaption>
                  <h4>Restaurant Renovation</h4>
                  <!--<span>Sub Title</span>-->
                  <p class="light_grey">Location: Collingwood</p>
                  <p>
                    Complete renovation &amp; repaint of a modern Indian eatery named
                    Madras Brothers. Smith St, Collingwood.
                  </p>
                  <a
                    href="/images/work/Madras%20Montage_Small.jpg"
                    data-rel="prettyPhoto[work_gallery]"
                    title="COMPLETE INTERIOR &amp; EXTERIOR REPAINT. MADRAS BROS, COLLINGWOOD"
                    >Take a look</a
                  >
                  <a
                    href="/images/work/Madras_Before%20&amp;%20After_Courtyard.jpg"
                    data-rel="prettyPhoto[work_gallery]"
                    title="EXTERIOR COURTYARD REPAINT, BEFORE &amp; AFTER."
                    >Take a look</a
                  >
                  <a
                    href="/images/work/Madras%20Bros-12_Small.jpg"
                    data-rel="prettyPhoto[work_gallery]"
                    title="MADRAS BROS, COLLINGWOOD."
                    >Take a look</a
                  >
                  <a
                    href="/images/work/Madras_Door_Before%20&amp;%20After.jpg"
                    data-rel="prettyPhoto[work_gallery]"
                    title="ENTRY &amp; SHOPFRONT REPAINT, BEFORE &amp; AFTER. MADRAS BROS, COLLINGWOOD."
                    >Take a look</a
                  >
                </figcaption>
              </figure>
            ...
            <li
              class="col-lg-3 col-sm-6 col-xs-6 portfolio-item shuffle-item filtered"
              data-groups='["all", "basement", "paintaing"]'
            >
              <figure>
                <div>
                  <img src="/images/work/TPD_Gallery 6.jpg" alt="img05" loading="lazy" />
                </div>
                <figcaption>
                  <h4>Patch Repair</h4>
                  <!--<span>Sub Title</span>-->
                  <p class="light_grey">Location: Keysborough</p>
                  <p>
                    Medium plaster wall repair after an accident exiting their manhole.
                  </p>
                  <a
                    href="/images/work/3Stage%20Patch%20Repair.jpg"
                    data-rel="prettyPhoto[work_gallery]"
                    title="Patch Repair"
                    >Take a look</a
                  >
            ...
            <li
              class="col-lg-3 col-sm-6 col-xs-6 portfolio-item shuffle-item filtered"
              data-groups='["all", "sanitary", "plumbing"]'
            >
              <figure>
                <div>
                  <img src="/images/work/TPD_Gallery 7.jpg" alt="img05" loading="lazy" />
                </div>
                <figcaption>
                  <h4>Ceiling Repairs</h4>
                  <!--<span>Sub Title</span>-->
                  <p class="light_grey">Location: Richmond</p>
                  <p>
                    Former downlight hole &amp; crack repairs in a modern apartment in
                    Richmond.
                  </p>
                  <a
                    href="/images/work/Gallery_Richmond.jpg"
                    data-rel="prettyPhoto[work_gallery]"
                    title="CEILING REPAIRS, RICHMOND"
                    >Take a look</a
                  >
                </figcaption>
              </figure>
            ...
            <li
              class="col-lg-3 col-sm-6 col-xs-6 portfolio-item shuffle-item filtered"
              data-groups='["all", "kitchen", "electrical"]'
            >
              <figure>
                <div>
                  <img src="/images/work/TPD_Gallery 8.jpg" alt="img05" loading="lazy" />
                </div>
                <figcaption>
                  <h4>Downlight Repairs</h4>
                  <!--<span>Sub Title</span>-->
                  <p class="light_grey">Location: Kensington</p>
                  <p>
                    Repairing numerous ceiling holes caused by switching to smaller
                    downlights.
                  </p>
                  <a
                    href="/images/work/Ceiling%20Light%20Patch_Flemington.jpg"
                    data-rel="prettyPhoto[work_gallery]"
                    title="MULTIPLE DOWNLIGHT HOLE REPAIRS, KENSINGTON."
                    >Take a look</a
                  >
                </figcaption>
              </figure>
          ...
          <ul id="portfoliogrid1" class="row portfolio mobile_text">
            <li
