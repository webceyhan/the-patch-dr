...
.navbar.top-nav-collapse a.navbar-brand .black_logo {
  opacity: 0;
}
.navbar.top-nav-collapse a.navbar-brand .white_logo {
  opacity: 1;
}
...
@media (max-width: 767px) {
  ...
  .top-nav-collapse .navbar-brand .black_logo {
    opacity: 0 !important;
  }
  .top-nav-collapse .navbar-brand .white_logo {
    opacity: 1 !important;
  }
}
</style>
